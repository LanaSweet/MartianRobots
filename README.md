...
The app calculates the route of the robots and returns the last position on the grid. If the robot has fallen of the grid the last position is followed by the word LOST.
