...
public class Main {
	...
	public static String routeImplementation(RobotLocation robot, String route) {
		...
		String result = robot.getX() + " " + robot.getY()  + " "+ robot.getDirection()  + " " + lost;
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File("C:\\Users\\Svit Juancho\\git\\MartianRobots\\MartianRobots\\src\\main\\resources\\output.txt")	));
